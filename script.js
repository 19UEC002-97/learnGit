document.addEventListener('DOMContentLoaded', function() {
    ...
    let food = { x : 300, y : 200 }; //{x: 15*20, y:10*20} // -> cell co-ordinate ->pixels
    ...
    function drawFoodAndSnake() {
        ...
        //wipe out and re-draw with new position
    ...
    function gameLoop(){
        //In every 200 misisec this callback will execute
...
function initiateGame() {
    ...
    document.body.insertBefore(scoreBoard, gameArena); //insert score board
